...
dui.Calendar.prototype = {
	...
	parseDate : function (date) {
		...
		if ( (month < 0 || month >= 12) || (dateOfMonth > this.GetMonDays(month) || dateOfMonth < 1) ) throw new Error("날짜가 잘못되었습니다.");
	...
	GetMonDays : function (month) {
		...
		return month ? DaysInMonth[month] : DaysInMonth[this.Month];
	},
