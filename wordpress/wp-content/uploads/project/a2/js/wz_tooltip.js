...
config. OffsetX			= -50		// Horizontal offset of left-top corner from mousepointer
...
config. Width			= '' 		// Tooltip width; 0 for automatic adaption to tooltip content; < -1 (e.g. -240) for a maximum width for that automatic adaption;
