...
Donate link: http://wensolutions.com/plugins/wen-skill-charts/
...
Plugin : [Homepage](http://wensolutions.com/plugins/wen-skill-charts/)
...
3. Select `wen-skill-charts.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

= Using FTP =

1. Download `wen-skill-charts.zip`
2. Extract the `wen-skill-charts` directory to your computer
3. Upload the `wen-skill-charts` directory to the `/wp-content/plugins/` directory
...
Nice, make a post on the [Support Forum](http://wordpress.org/support/plugin/wen-skill-charts "WEN Skill Charts Support") and let us know. We are always looking for ways to improve our plugins.
...
= 1.2 =
* Overall styling changes such as adding dragger and proper cross button.
* Separated settings for 'circle' & 'bar'.
* Added settings:
	- Circle size  
	- Circle width  
	- Track width  
